...
export function LearnIndexPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-brand-600 to-brand-700 text-white py-16 mb-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-6">
            <BookOpen className="h-10 w-10" />
            <Badge variant="secondary" className="text-brand-700 text-sm">
              Education Center
            </Badge>
          </div>
          ...
          <p className="text-xl text-brand-100 max-w-3xl mb-8">
        ...
        {categories.map((category) => {
          ...
          return (
            <section key={category.title} className="mb-12">
              <div className={`rounded-lg border-2 p-6 mb-6 ${colorClasses[category.color as keyof typeof colorClasses]}`}>
