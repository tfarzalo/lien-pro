...
export const HeroSection: React.FC = () => {
	return (
		<section className="bg-gradient-to-b from-brand-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-950 dark:to-slate-950 pt-16 pb-20 text-slate-900 dark:text-white overflow-hidden">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid gap-8 md:grid-cols-5 md:items-center">
				...
				<div className="relative md:col-span-3 lg:scale-110 xl:scale-125 lg:ml-8 xl:ml-16">
					{/* Decorative glow effect */}
					<div className="absolute -inset-4 bg-gradient-to-r from-brand-200/40 via-amber-200/40 to-brand-200/40 blur-3xl rounded-3xl dark:from-brand-900/40 dark:via-amber-900/40 dark:to-brand-900/40" aria-hidden />
