    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <a href="${import.meta.env.VITE_APP_URL || 'http://localhost:5173'}/dashboard" class="button">View in Dashboard</a>
        ...
        <div class="footer">
          ...
          <p><a href="${import.meta.env.VITE_APP_URL || 'http://localhost:5173'}/settings/notifications">Manage notification preferences</a></p>
        </div>
      </div>
    </body>
    </html>
...
View in Dashboard: ${import.meta.env.VITE_APP_URL || 'http://localhost:5173'}/dashboard
...
Manage notification preferences: ${import.meta.env.VITE_APP_URL || 'http://localhost:5173'}/settings/notifications
  `;
