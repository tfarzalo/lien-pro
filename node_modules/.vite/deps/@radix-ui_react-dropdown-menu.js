...
var Portal = React17.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime14.jsx)(Primitive5.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
function isSlottable6(child) {
  return React18.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER6;
}
...
function isSlottable7(child) {
  return React20.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER7;
}
...
var Slot8 = createSlot6("MenuContent.ScrollLock");
